    ...
    <div className="narrow-wrap fade-up">
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          {/* Seeker: booking accepted → single checklist → then track */}
          {isSeeker && booking.status === 'accepted' && (
            <div style={{marginBottom:16}}>
              {!checklistDone ? (
                <div style={{background:'rgba(76,175,80,0.08)',border:'1px solid rgba(76,175,80,0.25)',borderRadius:12,padding:'14px 16px'}}>
                  <div style={{fontWeight:700,color:'#4caf50',marginBottom:4}}>✅ Booking Accepted!</div>
                  <div style={{fontSize:13,color:'#aaa',marginBottom:12}}>
                    Complete the safety checklist then track your ride live.
                  </div>
                  <button className="btn btn-primary btn-full" onClick={() => setShowChecklist(true)}>
                    📋 Complete Safety Checklist
                  </button>
                </div>
              ) : (
                <div>
                  <div className="alert alert-success mb-12">✅ Safety checklist done — have a safe ride!</div>
                  <button
                    ...
                    onClick={() => navigate('live-tracking', {
                      ...
                      dropCoords: ride.drop?.coordinates?.length >= 2
                        ? { lat: ride.drop.coordinates[1], lng: ride.drop.coordinates[0] }
                        : null,
