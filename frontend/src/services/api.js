...
const getFallbackLocations = (query) => {
  ...
  const bangaloreColleges = [
    ...
    { name: 'international institute of information technology', display: 'IIIT Bangalore, Electronic City', lat: 12.8416, lng: 77.6603 },
    { name: 'iiit bangalore', display: 'IIIT Bangalore, Electronic City', lat: 12.8416, lng: 77.6603 },
    ...
    { name: 'acharya institute of technology', display: 'Acharya Institute of Technology, Soladevanahalli, Bangalore', lat: 13.0633, lng: 77.5122 },
    { name: 'acharya', display: 'Acharya Institute of Technology, Soladevanahalli, Bangalore', lat: 13.0633, lng: 77.5122 },
    { name: 'dayananda sagar college of engineering', display: 'Dayananda Sagar College of Engineering, Bangalore', lat: 12.9019, lng: 77.5679 },
    { name: 'dsce', display: 'Dayananda Sagar College of Engineering, Bangalore', lat: 12.9019, lng: 77.5679 },
    { name: 'reva university', display: 'REVA University, Yelahanka, Bangalore', lat: 13.1167, lng: 77.5942 },
    { name: 'reva', display: 'REVA University, Yelahanka, Bangalore', lat: 13.1167, lng: 77.5942 },
    { name: 'siddaganga institute of technology', display: 'Siddaganga Institute of Technology, Tumkur', lat: 13.3400, lng: 77.1010 },
    { name: 'sit', display: 'Siddaganga Institute of Technology, Tumkur', lat: 13.3400, lng: 77.1010 },
    { name: 'nm institute of technology', display: 'Nitte Meenakshi Institute of Technology, Yelahanka, Bangalore', lat: 13.1114, lng: 77.5963 },
    { name: 'nmit', display: 'Nitte Meenakshi Institute of Technology, Yelahanka, Bangalore', lat: 13.1114, lng: 77.5963 },
    { name: 'bangalore college of engineering', display: 'Bangalore College of Engineering, Bangalore', lat: 12.9539, lng: 77.6007 },
    { name: 'bce', display: 'Bangalore College of Engineering, Bangalore', lat: 12.9539, lng: 77.6007 },
    { name: 'sri krishna institute of technology', display: 'Sri Krishna Institute of Technology, Hesaraghatta, Bangalore', lat: 13.0707, lng: 77.5106 },
    { name: 'skit', display: 'Sri Krishna Institute of Technology, Hesaraghatta, Bangalore', lat: 13.0707, lng: 77.5106 },
    { name: 'don bosco institute of technology', display: 'Don Bosco Institute of Technology, Mysore Road, Bangalore', lat: 12.9282, lng: 77.5046 },
    { name: 'dbit', display: 'Don Bosco Institute of Technology, Mysore Road, Bangalore', lat: 12.9282, lng: 77.5046 },
    { name: 'east west college of engineering', display: 'East West College of Engineering, Bangalore', lat: 12.9795, lng: 77.6513 },
    { name: 'ewce', display: 'East West College of Engineering, Bangalore', lat: 12.9795, lng: 77.6513 },
    { name: 'garden city college of engineering', display: 'Garden City College of Engineering, Bangalore', lat: 13.0150, lng: 77.6389 },
    { name: 'gcce', display: 'Garden City College of Engineering, Bangalore', lat: 13.0150, lng: 77.6389 },
    { name: 'global academy of technology', display: 'Global Academy of Technology, Ideal Homes, Bangalore', lat: 12.9449, lng: 77.4768 },
    { name: 'gat', display: 'Global Academy of Technology, Ideal Homes, Bangalore', lat: 12.9449, lng: 77.4768 },
    { name: 'hkbk college of engineering', display: 'HKBK College of Engineering, HBR Layout, Bangalore', lat: 13.0210, lng: 77.6450 },
    { name: 'hkbk', display: 'HKBK College of Engineering, HBR Layout, Bangalore', lat: 13.0210, lng: 77.6450 },
    { name: 'indian institute of information technology', display: 'IIIT Bangalore, Electronic City', lat: 12.8416, lng: 77.6603 },
    { name: 'iiitb', display: 'IIIT Bangalore, Electronic City', lat: 12.8416, lng: 77.6603 },
...
export const resetPasswordWithOtp = (resetToken, password) =>
  request('/auth/reset-password-otp', { method: 'POST', body: JSON.stringify({ resetToken, password }) });

// Nearby users & route
export const getNearbyUsers = ({ lat, lng, radius = 5000 } = {}) =>
  request(`/location/nearby-users?lat=${lat}&lng=${lng}&radius=${radius}`);
export const getRoute = ({ fromLat, fromLng, toLat, toLng }) =>
...
export const searchRides = ({ lat, lng, maxDistance = 5000, date, womenOnly } = {}) => {
  ...
  return request(`/ride/search?${params.toString()}`);
};
...
export const deleteChatMessage = (id) =>
  request(`/community/chat/messages/${id}`, { method: 'DELETE' });
